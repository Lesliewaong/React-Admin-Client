...
1. 我们在github上面新建一个远程仓库，名字也叫test
    记录远程仓库的地址（eg: [https://github.com/fyxwanan/author-demo.git](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Ffyxwanan%2Fauthor-demo.git)）
2. 修改并完善项目，达到你想要的那种程度，疯狂敲代码
3. ![\color{red}{重要}](https://math.jianshu.com/math?formula=%5Ccolor%7Bred%7D%7B%E9%87%8D%E8%A6%81%7D)在package.json配置文件中加一句：
...
1. ![\color{red}{重要}](https://math.jianshu.com/math?formula=%5Ccolor%7Bred%7D%7B%E9%87%8D%E8%A6%81%7D)在github展示的是静态的html文件，我们上传的react项目是不能预览的，此时我们可以把打包好的build文件夹上传到另一个分支
...
2. 进入仓库，点击Setting,找到GitHub Pages这一块，修改Source选择刚刚的gh-pages，然后保存
   ...
   ![img](https:////upload-images.jianshu.io/upload_images/18026767-1f7158e4450b7db9.png?imageMogr2/auto-orient/strip|imageView2/2/w/777/format/webp)
